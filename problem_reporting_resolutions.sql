...
CREATE TABLE `resolutions` (
  ...
  CONSTRAINT `admin_id` FOREIGN KEY (`Admin_Id`) REFERENCES `users` (`Users_Id`),
  CONSTRAINT `issue_id` FOREIGN KEY (`issue_id`) REFERENCES `issues` (`issues_Id`)
...
INSERT INTO `resolutions` VALUES (1,1,3,'Sidewalk fixed on 18th Feb.','2025-02-19 16:10:56');
